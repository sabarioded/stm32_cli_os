...
/* ---------- STM32L476 peripheral IRQ handlers (weak -> Default_Handler) ---------- */
...
void DFSDM3_IRQHandler          (void) __attribute__((weak, alias("Default_Handler")));
...
void DFSDM0_IRQHandler          (void) __attribute__((weak, alias("Default_Handler")));
void DFSDM1_IRQHandler          (void) __attribute__((weak, alias("Default_Handler")));
